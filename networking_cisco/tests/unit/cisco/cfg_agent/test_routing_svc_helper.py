...
class TestBasicRoutingOperations(
    ...
    def _unmock_and_mock_things(self):
        import types
        from networking_cisco.plugins.cisco.cfg_agent.device_drivers.asr1k import (
            asr1k_routing_driver as driver)

        self.routing_helper._internal_network_added = types.MethodType(
            routing_svc_helper.RoutingServiceHelper._internal_network_added,
            self.routing_helper)
        self.routing_helper._internal_network_removed = types.MethodType(
            routing_svc_helper.RoutingServiceHelper._internal_network_removed,
            self.routing_helper)
        ...
        self.routing_helper._drivermgr = mock.MagicMock()
        self.routing_helper._drivermgr.get_driver.return_value = self.driver
